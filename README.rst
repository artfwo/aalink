...
It provides awaitable objects for synchronizing Python code with an Ableton
Link session, but it may also be used for writing completely standalone scripts
with tempo/beat synchronization, such as applications for light and sound
control.
...
Combine synced coroutines to run in series or in parallel:
